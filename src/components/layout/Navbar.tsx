...
const Navbar = () => {
  ...
  return (
    <>
      <nav
        className={cn(
          'fixed top-0 left-0 right-0 z-50 transition-luxury py-4',
          isScrolled ? 'bg-white/95 backdrop-blur-md py-3 shadow-sm' : 'bg-transparent'
        )}
      >
        <div className="container mx-auto px-6 md:px-12 flex items-center justify-between">
          ...
          <div className="flex items-center gap-4 md:gap-6">
            <Link to="/favoritos" className="p-2 text-clara-black hover:text-clara-pink-500 transition-colors">
              <Heart size={20} />
            </Link>
            <button 
